...
taxa = float(input("Informe a taxa em precentual: "))
...
# Saída dos Dados
print(f"A prestacao se encontra {tempo} dias atrasada, gerando juros de R$ {juros:.2f}, portanto o valor final a ser pago será de R$ {valorfinal:,.2f} ")
